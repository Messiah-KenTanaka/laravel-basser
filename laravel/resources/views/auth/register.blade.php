            ...
            <div class="card-text">
              <form action="POST" action="{{ route('register') }}">
                ...
                <div class="md-form">
                  ...
                  <input class="from-control" type="text" id="name" name="name" required value="{{ old('name') }}">
                ...
                <button class="btn btn-block blue-gradient mt-2 mb-2" type="submit">バサー登録</button>
              </form>
              <div class="mt-0">
